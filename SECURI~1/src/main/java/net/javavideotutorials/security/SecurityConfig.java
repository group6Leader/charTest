package net.javavideotutorials.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
	...
	protected void configure(HttpSecurity http) throws Exception
	{
		http.authorizeRequests()
		    ...
		    // isn't the best approach as a malicious user could log other users out.
		    // You can omit this line to force POST logouts only via the default logout
